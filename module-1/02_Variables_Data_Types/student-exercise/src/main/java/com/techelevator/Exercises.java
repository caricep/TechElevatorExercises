...
public class Exercises {
	...
	public static void main(String[] args) {
        ...
        */
		String firstName = "Carice";
		String lastName = "Poston";
        ...
        */
		float distanceBetweenNewYorkAndChicagoInMiles = 800;
		float distanceAlreadyTravelledInMiles = 537;
		float percentageOfTripCompleted = (distanceAlreadyTravelledInMiles / distanceBetweenNewYorkAndChicagoInMiles) * 100; 
		System.out.println((int)percentageOfTripCompleted);
