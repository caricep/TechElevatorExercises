...
-- The name, continent, GNP, and average life expectancy of all countries in Africa or Asia that have an 
-- average life expectancy of at least 70 years and a GNP between $1 billion and $100 billion dollars
SELECT *
FROM country
